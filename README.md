...
| [BUG Robot](https://github.com/nilutpolkashyap/bug_robot) | [Autonomous Navigation Robot](https://github.com/nilutpolkashyap/auto_nav_robot) | [Gripper Robot](https://github.com/nilutpolkashyap/gripper_bot) | [Line Follower/ Maze Solver](https://github.com/nilutpolkashyap/maze_robot) | [Self Driving Car Simulation](https://github.com/nilutpolkashyap/self_driving_car)  |
| -------------------------------------------------------------------------------- | --------------------------------------------------------------------------- | ------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| ROS - Bug 0, 1, 2 Algorithms | ROS - Robot with SLAM & Autonomous Navigation | ROS - Robot Simulation with Gripper & GUI. | ROS - Line Follower & Maze Solver Robot Using OpenCV | Udacity Self Driving Car Simulation |
